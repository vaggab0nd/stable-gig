...
from app.routers import analyse, auth, profiles, address, user_metadata, photo_analysis, task_breakdown, jobs, bids
...
app.include_router(task_breakdown.router)  # POST /analyse/breakdown
app.include_router(jobs.router)            # /jobs — homeowner job management
app.include_router(bids.router)            # /jobs/{id}/bids, /me/bids — contractor bidding
